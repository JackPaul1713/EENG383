...
void main(void) {
    ...
    uint8_t sin[16] = {128, 176, 218, 245, 255, 245, 218, 176, 128, 79, 37, 10, 0, 10, 37, 79};
    uint8_t i;
    char cmd;
        ...
        if ((EUSART1_is_rx_ready())) {
            ...
            switch (cmd) {
                ...
                case 'w':
                    ...
                    while ((EUSART1_is_rx_ready()) == 0) {
                        for (phaseIncrement = 3; phaseIncrement < 13; phaseIncrement++) {
