   ...
   switch (cmd)
            {
                ...
                case 'c':
                    ...
                    printf("Unsorted\r\n");
                    for (i = 0; i < 8; i++) printf("%u  ", sample[i]);
                    printf("\r\n");
...
# 200 "main.c"
                            red = echo >> 6;
                            green = 256 - red;
                            if(red > 256) {red = 256; green = 0;}
                            printf("\rred(%3u), green(%3u)", red, green);
                            EPWM2_LoadDutyValue(red);
                            EPWM1_LoadDutyValue(green);
                            newEcho = 0;
                        }
                    }
                    (void) EUSART1_Read();
...
void CCP4ISR(uint16_t capture)
{
    ...
    else if(CCP4CONbits.CCP4M == 0b0100)
    {
