...
void main(void)
{
    ...
    for (;;)
    {
        ...
        for(int i = 0; i < 9; i++) blink(message[i]);
    }
}
...
void blink(char letter)
{
    ...
    if(i == 255)
    {
       milliSecondDelay(timeUnit * 4);
       return;
    }

    while(morseCode[i][j] != 2)
    {
        if(morseCode[i][j] == 0)
        {
            LATBbits.LATB5 = 0;
            milliSecondDelay(timeUnit * 1);
            LATBbits.LATB5 = 1;
        }
        else if(morseCode[i][j] == 1)
        {
            LATBbits.LATB5 = 0;
            milliSecondDelay(timeUnit * 3);
            LATBbits.LATB5 = 1;
        }
