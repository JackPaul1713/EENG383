        ...
        if ((EUSART1_is_rx_ready()))
        {
            ...
            switch (cmd)
            {
                ...
                case 'r':
                    ...
                    break;
                case 'w':
                    for (i = 0; i < 512; i++) doubleBuffer[0][i] = 255 - i;
                ...
                case '0':
                    ...
                    for (i = 0; i < 512; i++)
                    {
                        ...
                        printf("write to "); printf("%04x:", currentAddress >> 16); printf("%04x ", currentAddress & 0x0000FFFF);
                ...
                case '+':
                    if((sampleRate + 160) > sampleRate) sampleRate += 160;
                ...
                case 's':
                    ...
                    for(i = 0; i < 512; i++)
                    {
                        ...
                        for(j = 0; j < 512; j++)
                        {
                            printf("%u%s", doubleBuffer[0][j], "\n");
                            if((EUSART1_is_rx_ready()) == 1) break;
                        }
                        if((EUSART1_is_rx_ready()) == 1) break;
...
void rwTMR0ISR(void)
{
    ...
    if(recording)
    {
        ...
        character = ADRESH;
        doubleBuffer[sampleIndex][i] = character;
